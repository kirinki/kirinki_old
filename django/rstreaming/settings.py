...
ADMINS = (
    ('Pablo Alvarez de Sotomayor Posadillo', 'palvarez@kirinki.net'),
)
...
MEDIA_ROOT = '/home/i02sopop/rstreaming/django/rstreaming/static/'
...
TEMPLATE_DIRS = (
    ...
    '/usr/src/rstreaming/django/rstreaming/templates'
    # 'templates'
)
...
EMAIL_PORT = '25'
EMAIL_HOST_USER = 'no-reply@kirinki.net'
EMAIL_HOST_PASSWORD = ''
EMAIL_USE_TLS = True
